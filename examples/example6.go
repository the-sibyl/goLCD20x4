...
func main() {
	...
	lcd.WriteLine("Special chars. demo", 1)
	lcd.WriteLine(sc.LeftArrow + " Left arrow with", 2)
	lcd.WriteLine("string concatenation", 3)
	lcd.WriteLine("and right arrow " + sc.RightArrow, 4)
}
